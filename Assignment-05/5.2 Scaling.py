...
# translated
def translated (vertexX, vertexY, numVertex, color, scaleX, scaleY) :
	for i in range (numVertex) :
...
if __name__ == '__main__' :
		...
		translated (vertexX, vertexY, numVertex, red, scaleX, 1)
		# draw the polygon translated Y
		translated (vertexX, vertexY, numVertex, blue, 1, scaleY)
		# draw the polygon translated XY
		translated (vertexX, vertexY, numVertex, purple, scaleX, scaleY)
